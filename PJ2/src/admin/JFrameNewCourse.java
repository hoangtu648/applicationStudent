...
public class JFrameNewCourse extends JFrame implements ActionListener,CourseObserver {
	...
	public JFrameNewCourse(ControllerCourseInterface controller, CourseModelInterface model) {
		super();
...
//5,Cau truc du lieu,24/05/2023,3000000,9,7months,C:\Users\ACER\Desktop\image\ctdl.jpg,100,6-7,17-19
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == jbuttonCreate) {
			Course c = courseModel.findCourseByName(jtextFieldCourseName.getText());
